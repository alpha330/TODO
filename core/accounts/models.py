...
class UserManager(BaseUserManager):
    ...
    def create_user(self, email, password, **kwargs):
        """_summary_
        this def for creating user with data
        comes from clients with extra fields as kwargs
...
class Users(AbstractBaseUser, PermissionsMixin):
    ...
    app for customization auth model
    this model class inherent from
    AbstractBaseUser and PermissionMixin
    parent class
    to make it work with Django's
