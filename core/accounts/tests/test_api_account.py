...
class TestApiV1Accounts:
    ...
    def test_api_user_registration_response_400_status(self, api_client):
        ...
        """
        data = {"email": "test", "password": "123qwe!@#", "password_1": "123qwe!@#"}
        url = reverse("accounts:api-v1:registration")
        response = api_client.post(url, data)
        assert response.status_code == 400

    def test_api_user_confirm_get_response_200_status(
        self, api_client, real_user_unverified
    ):
        """
    ...
    def test_api_v1_user_reset_password_link_post_200_status(
        self, api_client, real_user
    ):
        """
